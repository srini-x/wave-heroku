...
Wave makes it very easy to create data science applications.
Heroku is a cloud platform where we can quickly deploy our Wave app and share it with the rest of the world. To know more about Heroku, read [What is Heroku ?][what-is-heroku]
...
And yes, we can deploy our Wave apps for free on Heroku.
...
- [1. Create a Wave App](#1-create-a-wave-app)
    - [Clone the repo](#clone-the-repo)
    - [Setup Virtual Environment](#setup-virtual-environment)
    - [Run the Wave App](#run-the-wave-app)
- [2. Dockerize the Wave app](#2-dockerize-the-wave-app)
    - [Get Dockerfile](#get-dockerfile)
    - [Build the Docker Image](#build-the-docker-image)
    - [Run the Wave app using Docker](#run-the-wave-app-using-docker)
- [3. Deploy the Docker image to Heroku](#3-deploy-the-docker-image-to-heroku)
    - [Log into Heroku using CLI](#log-into-heroku-using-cli)
    - [Log into Container Registry](#log-into-container-registry)
    - [Create a Heroku app](#create-a-heroku-app)
    - [Tag the Docker Image](#tag-the-docker-image)
    - [Push the image to Heroku](#push-the-image-to-heroku)
    - [Release the image to your app](#release-the-image-to-your-app)
    - [Open the app in your browser](#open-the-app-in-your-browser)
